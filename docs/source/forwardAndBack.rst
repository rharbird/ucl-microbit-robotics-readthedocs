...
3. Take a look at the diagram below, you will see that the motor takes almost 200 milliseconds to move through 180°. Add a pause of 180 milliseconds after the ``angle`` variable has been reset to 0. This is so that the micro:bit will wait for the motor to move to angle 0° before moving it again.
